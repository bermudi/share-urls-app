...
export function BundleSettings({
  ...
  useEffect(() => {
    ...
    if (!isValidVanityUrl(vanityUrl)) {
      setVanityUrlError('Only letters, numbers, hyphens, and underscores allowed (3-50 characters)');
      setVanityUrlValid(false);
    } else {
      setVanityUrlError('');
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-2">
        ...
        {!vanityUrl && (
          <p className="text-sm text-gray-500 dark:text-gray-400">Leave empty for auto-generated URL</p>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Describe your collection of links..."
          rows={3}
